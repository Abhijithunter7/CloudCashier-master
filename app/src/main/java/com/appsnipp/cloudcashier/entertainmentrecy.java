...
public class entertainmentrecy extends AppCompatActivity implements TransportDataAdapter.OnItemClickListener {

    private RecyclerView recyclerView;
    private TransportDataAdapter transportDataAdapter;
    private List<TransportData> transportDataList;
    private DatabaseReference entertainmentRef;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_entertainmentrecy); // Replace with your actual layout file name
        ...
        if (ccurrentUser != null) {
            ...
            entertainmentRef = mdatabase.getReference().child(userid).child("entertainment");
        }

        // Initialize recycler view
        recyclerView = findViewById(R.id.entertainmentrecycler); // Replace with the actual ID from your layout
    ...
    private void fetchDataFromFirebase() {
        entertainmentRef.addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void onNoteClickListener(int position) {
        ...
        Intent intent = new Intent(entertainmentrecy.this, entertainment.class);
    ...
    private void deleteNote(int position) {
        ...
        DatabaseReference noteRef = entertainmentRef.child(noteId);
        noteRef.removeValue(new DatabaseReference.CompletionListener() {
            @Override
            public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                if (error != null) {
                    Toast.makeText(entertainmentrecy.this, "Failed to delete note: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(entertainmentrecy.this, "Note deleted successfully", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
