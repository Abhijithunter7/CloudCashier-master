...
public class personl_graph extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personl_graph);
        ...
        if(ccurrentUser!=null) {
            ...
            databaseReference = mdatabase.getReference().child(userid).child("personal care");
        }
