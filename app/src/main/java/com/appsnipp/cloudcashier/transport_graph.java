...
public class transport_graph extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transport_graph);
        ...
        if(ccurrentUser!=null) {
            ...
            databaseReference = mdatabase.getReference().child(userid).child("transport");
        }
    ...
    private void fetchDataByDate(String date) {
        ...
        databaseReference.orderByChild("selectedDate").equalTo(date).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Log.e("TransportGraph", "Error fetching data by date", error.toException());
            }
        });
    }
    ...
    private void fetchDataByMonth(int year, int month) {
        ...
        databaseReference.orderByChild("selectedDate").startAt(startDate).endAt(endDate).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                // Handle errors during data fetching
                Log.e("TransportGraph", "Error fetching data by month", error.toException());
            }
        });
    }
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Log.d("TransportGraph", "No data found in Firebase");
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                // Handle errors during data fetching
                Log.e("TransportGraph", "Error fetching data by year", error.toException());
            }
        });
    }
    ...
    private void onYearlyValueSelected(int index, List<BarEntry> entries, List<String> yearLabels) {
        ...
        if (index >= 0 && index < entries.size() && !yearLabels.isEmpty()) {
            ...
            Log.e("TransportGraph", "Index out of bounds or empty lists");
        }
