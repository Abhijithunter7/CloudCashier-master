...
public class foodrecy extends AppCompatActivity implements TransportDataAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_foodrecy); // Replace with your actual layout file name
        ...
        if (ccurrentUser != null) {
            ...
            foodRef = mdatabase.getReference().child(userid).child("food");
        }

        // Initialize recycler view
        recyclerView = findViewById(R.id.foodrecycler); // Replace with the actual ID from your layout
    ...
    public void onNoteClickListener(int position) {
        ...
        Intent intent = new Intent(foodrecy.this, food.class);
    ...
    private void deleteNote(int position) {
        ...
        DatabaseReference noteRef = foodRef.child(noteId);
        noteRef.removeValue(new DatabaseReference.CompletionListener() {
            @Override
            public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                if (error != null) {
                    Toast.makeText(foodrecy.this, "Failed to delete note: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(foodrecy.this, "Note deleted successfully", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
