...
public class insurance_graph extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ccurrentUser!=null) {
            ...
            databaseReference = mdatabase.getReference().child(userid).child("insurance");
        }
