...
public class educationrecy extends AppCompatActivity implements TransportDataAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_educationrecy); // Replace with your actual layout file name
        ...
        if (ccurrentUser != null) {
            ...
            educationRef = mdatabase.getReference().child(userid).child("education");
        }

        // Initialize recycler view
        recyclerView = findViewById(R.id.educationrecycler); // Replace with the actual ID from your layout
    ...
    public void onNoteClickListener(int position) {
        ...
        Intent intent = new Intent(educationrecy.this, Education.class);
    ...
    private void deleteNote(int position) {
        ...
        DatabaseReference noteRef = educationRef.child(noteId);
        noteRef.removeValue(new DatabaseReference.CompletionListener() {
            @Override
            public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                if (error != null) {
                    Toast.makeText(educationrecy.this, "Failed to delete note: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(educationrecy.this, "Note deleted successfully", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
