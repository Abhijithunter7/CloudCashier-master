...
public class homemain_graph extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homemain_graph);
        ...
        if(ccurrentUser!=null) {
            ...
            databaseReference = mdatabase.getReference().child(userid).child("home_maintenance");
        }
