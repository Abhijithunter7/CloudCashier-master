...
public class entertainment_graph extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entertainment_graph);
        ...
        if(ccurrentUser!=null) {
            ...
            databaseReference = mdatabase.getReference().child(userid).child("entertainment");
        }
